...
router.post('/api/products', isAuthenticated, upload.array('images', 5), async (req, res) => {
    try {
...
router.put('/api/products/:id', isAuthenticated, upload.array('newImages', 5), async (req, res) => {
    try {
...
router.get('/api/orders/:id/track', async (req, res) => {
    try {
...
// Review endpoints
router.post('/api/reviews', isAuthenticated, async (req, res) => {
    try {
